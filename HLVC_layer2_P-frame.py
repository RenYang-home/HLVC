...
parser.add_argument("--com", default='com_P.png')
parser.add_argument("--bin", default='bits_P.bin')
...
model_path = './HLVC_model/Layer2_P-frame/' \
             'Layer2_P_' + args.mode + '_' + str(args.l) + '_model/model.ckpt'
